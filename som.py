# -*- coding: utf-8 -*-
"""
Created on Wed Feb  7 17:17:41 2018
...
for file_name in file_names:
    img_smt = cv2.imread(os.path.join(dir_input, file_name))
    imgray = cv2.cvtColor(img_smt, cv2.COLOR_BGR2GRAY)
    resized_image = cv2.resize(imgray, (16, 16)) 
#    print(resized_image.shape)
    
    letters.append(resized_image.reshape(-1))

letters = np.array(letters)
print(letters.shape)

som = SOM(20, 30, len(letters[0]), 400)
som.train(letters)
